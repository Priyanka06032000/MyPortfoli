    ...
    render(){
            ...
            <div className="contact-body">
                ...
                <Cell col={6}>
                    ...
                    style={{height:'300px'}}
                    />
                    <p>Have bean a learner and learning to lean from everything. 
                        Always ready to learn new things.
                    Intrested in Technology, Computer Programing, Software Testing, Internet of Things,etc
                    And yeah music and food is VIP for me.
                        ...
                        <ListItem>
                         ...
                         <ListItem>
                               ...
                               <i class="fa fa-envelope" aria-hidden="true"></i>
                                priyathorat@gmail.com</ListItemContent>
                         </ListItem>
                         <ListItem>
                               <ListItemContent style={{fontSize:'25px',fontFamily:'Anton'}}>
